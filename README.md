...
- `OPENAI_API_KEY`: required when enough sources exist to generate a normal brief.
...
Feishu failure does not block a successful Pages deployment. Tests, generation, schema validation, or Pages deployment failures block the workflow.
